...
import { API_URL, MEDIA_URL } from "../../config"; // Asegúrate de importar la URL de la API
...
const Login = () => {
  ...
  const [preguntaSecretaError, setPreguntaSecretaError] = useState("");
  const [respuestaSecretaError, setRespuestaSecretaError] = useState("");
  ...
  const clearValidationErrors = () => {
    ...
    setPreguntaSecretaError("");
    setRespuestaSecretaError("");
  };
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    if (!preguntaSecreta) {
      setPreguntaSecretaError("Debes seleccionar una pregunta secreta");
      isValid = false;
    } else {
      setPreguntaSecretaError("");
    }
    ...
    if (!respuestaSecreta) {
      setRespuestaSecretaError("Debes proporcionar una respuesta");
      isValid = false;
    } else {
      setRespuestaSecretaError("");
    }
    ...
    console.log("Datos completos:", datosRegistro);
    console.log("Pregunta Secreta:", preguntaSecreta);
    console.log("Respuesta Secreta:", respuestaSecreta);
    console.log("========================================================");

    try {
      console.log("Iniciando petición POST a:", `${API_URL}/usuarios/registro`);
  ...
  const styles = {
    pageContainer: {
      ...
      backgroundImage: `url(${MEDIA_URL}/msh9p2wcajtirx16jji8.jpg)`,
          ...
          <div style={styles.leftContent}>
            <div style={styles.welcomeContainer}>
              ...
              <p style={styles.welcomeText}>
                Inicia sesión para acceder a tu cuenta o crea una nueva para
                disfrutar de todos nuestros servicios y productos tecnológicos.
              </p>
            </div>
            ...
            <div style={styles.featureContainer}>
              <div style={styles.brandFeature}>
                ...
                <div style={styles.featureText}>
                  Acceso rápido a todos nuestros servicios
                </div>
              </div>
            </div>
                ...
                <>
                  ...
                  <Form onSubmit={handleLoginSubmit}>
                    <div style={styles.inputBox}>
                      ...
                      />
                      {loginEmailError && (
                        <p style={errorMessageStyle}>{loginEmailError}</p>
                      )}
                    </div>

                    <div style={styles.inputBox}>
                      <label htmlFor="login-password" style={styles.inputLabel}>
                        Contraseña
                      </label>
                      <span style={{ ...styles.icon, top: "calc(50% + 10px)" }}>
                      ...
                      {loginPasswordError && (
                        <p style={errorMessageStyle}>{loginPasswordError}</p>
                      )}
                    </div>
                  ...
                  <div style={styles.termsText}>
                    ...
                    <Link to="/politicas#cliente" style={styles.highlight}>
                      Políticas de Cliente
                    </Link>{" "}
                    y{" "}
                    <Link to="/politicas#privacidad" style={styles.highlight}>
                ...
                <>
                  ...
                  <Form onSubmit={handleRegisterSubmit}>
                    <div style={styles.inputRow}>
                      <div style={styles.inputBox}>
                        <label htmlFor="reg-nombre" style={styles.inputLabel}>
                          Nombre
                        </label>
                        <input
                          id="reg-nombre"
                        ...
                        />
                        {nombreError && (
                          <p style={errorMessageStyle}>{nombreError}</p>
                        )}
                      </div>
                      <div style={styles.inputBox}>
                        <label htmlFor="reg-apellido" style={styles.inputLabel}>
                          Apellido
                        </label>
                        <input
                          id="reg-apellido"
                          ...
                          style={{
                            ...styles.input,
                            ...(apellidoError ? styles.inputError : {}),
                          }}
                        />
                        {apellidoError && (
                          <p style={errorMessageStyle}>{apellidoError}</p>
                        )}
                      </div>
                    </div>

                    <div style={styles.inputBox}>
                      <label htmlFor="reg-telefono" style={styles.inputLabel}>
                        Teléfono
                      </label>
                      <span style={{ ...styles.icon, top: "calc(50% + 10px)" }}>
                      ...
                      />
                      {telefonoError && (
                        <p style={errorMessageStyle}>{telefonoError}</p>
                      )}
                    </div>

                    <div style={styles.inputBox}>
                      <label htmlFor="reg-email" style={styles.inputLabel}>
                        Correo Electrónico
                      </label>
                      <span style={{ ...styles.icon, top: "calc(50% + 10px)" }}>
                        <IonIcon icon={mailOutline} />
                      ...
                      />
                      {emailError && (
                        <p style={errorMessageStyle}>{emailError}</p>
                      )}
                    </div>

                    <div style={styles.inputBox}>
                      <label htmlFor="reg-password" style={styles.inputLabel}>
                        Contraseña
                      </label>
                      <span style={{ ...styles.icon, top: "calc(50% + 10px)" }}>
                        <IonIcon icon={lockClosedOutline} />
                      ...
                      {passwordError && (
                        <p style={errorMessageStyle}>{passwordError}</p>
                      )}
                    </div>
                    ...
                    <div style={styles.inputBox}>
                      ...
                      {confirmPasswordError && (
                        <p style={errorMessageStyle}>{confirmPasswordError}</p>
                      )}
                    </div>

                    <div style={styles.inputBox}>
                      <label
                        htmlFor="pregunta-secreta"
                        style={styles.inputLabel}
                      >
                        Pregunta Secreta
                      </label>
                      <select
                        ...
                        onChange={(e) => {
                          setPreguntaSecreta(e.target.value);
                          setPreguntaSecretaError("");
                        }}
                        style={{
                          ...styles.selectInput,
                          ...(preguntaSecretaError ? styles.inputError : {}),
                        }}
                      >
                      ...
                      {preguntaSecretaError && (
                        <p style={errorMessageStyle}>{preguntaSecretaError}</p>
                      )}
                    </div>

                    <div style={styles.inputBox}>
                      <label
                        htmlFor="respuesta-secreta"
                        style={styles.inputLabel}
                      >
                        Respuesta Secreta
                      </label>
                      <input
                        id="respuesta-secreta"
                        type="text"
                        placeholder="Tu respuesta secreta"
                        value={respuestaSecreta}
                        onChange={(e) => {
                          setRespuestaSecreta(e.target.value);
                          setRespuestaSecretaError("");
                        }}
                        style={{
                          ...styles.input,
                          ...(respuestaSecretaError ? styles.inputError : {}),
                        }}
                      />
                      {respuestaSecretaError && (
                        <p style={errorMessageStyle}>{respuestaSecretaError}</p>
                      )}
                    </div>
                    ...
                    >
                      ...
                      {termsError && (
                        <p style={errorMessageStyle}>{termsError}</p>
                      )}
                    </div>
                  ...
                  <div style={styles.termsText}>
                    Al registrarte, aceptas recibir correos electrónicos de
                    marketing de JADA Technology. Puedes darte de baja en
                    cualquier momento.
                  </div>
                </>
              )}
